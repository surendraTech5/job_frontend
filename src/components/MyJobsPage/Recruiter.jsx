...
const Recruiter = () => {
    const {
        ...
        queryFn: async () => {
            const response = await axios.get(
                `${import.meta.env.VITE_API_BASE_URL}/api/v1/application/recruiter-jobs`, // import.meta.env
                {
    ...
    const handleAcceptStatus = (id, recruiterId) => {
        ...
        updateJobStatusMutation.mutate({
            body: newStatus,
            url: `${import.meta.env.VITE_API_BASE_URL}/api/v1/application/${id}`, // import.meta.env
        });
    };
