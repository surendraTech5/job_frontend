...
const ManageUsers = () => {
    ...
    const {
        ...
        queryKey: ["users"],
        queryFn: () =>
            getAllHandler(`${import.meta.env.VITE_API_BASE_URL}/api/v1/users`), // import.meta.env
    });
    ...
    const UpdateUserRole = async (id, role) => {
        ...
        try {
            const response = await axios.patch(
                `${import.meta.env.VITE_API_BASE_URL}/api/v1/admin/update-role`, // import.meta.env
                updateUser,
